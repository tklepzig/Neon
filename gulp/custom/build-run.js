...
module.exports = function(gulp, plugins, config) {
    ...
    gulp.task('build', function(done) {
        plugins.runSequence('clean', ['copyStatic', 'scripts', 'styles'], 'index', 'entry-page', 'manifest', done);
    });

    // build (for dev)
    gulp.task('build:dev', function(done) {
        plugins.runSequence( /*'karma',*/ 'clean', ['copyStatic', 'scripts:dev', 'styles:dev'], 'index:dev', 'entry-page', 'manifest', done);
    });
